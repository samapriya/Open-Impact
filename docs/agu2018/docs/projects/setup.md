...
directly in your browser. It's also your gateway to creating a Planet Account,and gaining access to Planet's APIs.To sign up, visit [planet.com/explorer](https://www.planet.com/explorer/) and click **Get Started**:

<center>![getstarted](https://developers.planet.com/docs/quickstart/getting-started/images/getstarted.png)</center>

Get started with Planet Explorer
From there, click **Sign Up** in the top right of your screen, and enter your email address to receive an invitation:

<center>![signup](https://developers.planet.com/docs/quickstart/getting-started/images/signup.png)</center>
